...
* !!!! WARNING: THIS DOES NOT MAP DOWN THE THRUST - DO NOT GO TOO HIGH !!!!
*/
...
#define ADC_CHANNEL ADC_CHANNEL_3   // GPIO4 (A0)
...
void ADCTask(void *arg) {
    ...
    while (1)
    {
        ...
        dutyCalc = (potentiometer_read >> (12 - MOTORS_PWM_BITS + 1)) + (1 << (MOTORS_PWM_BITS-1));
        ESP_LOGI(TAG,"Width: %u\n",dutyCalc);
