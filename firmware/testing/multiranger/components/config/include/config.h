...
#define MULTIRANGER_TASK_PRI    5 // @@ Added
...
#define MULTIRANGER_TASK_NAME   "MULTIRANGER" // @@ Added
...
#define MULTIRANGER_TASK_STACKSIZE    (2 * configBASE_STACK_SIZE) // @@ Added. May need more size though...
