...
//thrust is thrust mapped for 65536 <==> 60 GRAMS! //@@ UPDATE THIS WHEN ADJUSTING THRUST LIMITS
//@@ (07 Oct 2025) Using 41000 <==> 300g from test data
#define CONTROL_TO_ACC (GRAVITY_MAGNITUDE*300.0f/(CF_MASS*1000.0f)/41000.0f) // @@ original: (GRAVITY_MAGNITUDE*60.0f/(CF_MASS*1000.0f)/65536.0f)
