...
#define THRUSTMAP_MAX 50000u//41000u // @@ max thrust to remap to (0-65536)
// @@ you should update the kalman filter CONTROL_TO_ACC macro in 'estimator_kalman.c' when adjusting thrust limits
// @@ but obviously you need to know the corresponding max thrust to do properly
// @@ the line to change is: #define CONTROL_TO_ACC (GRAVITY_MAGNITUDE*300.0f/(CF_MASS*1000.0f)/41000.0f)
// @@                                                              grams ^           THRUSTMAP_MAX ^
...
bool pwm_timmer_init()
{
    ...
    ledc_timer_config_t ledc_timer = {
        ...
        .freq_hz = 500,					// frequency of PWM signal @@ MODIFICATION (originally 15000Hz)
